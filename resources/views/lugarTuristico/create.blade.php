...
@section('contenido')
<div class="container">
    <h2>Crear Nuevo Lugar Turístico</h2>

    <form id="formLugar" action="{{ route('lugares.store') }}" method="POST">
        @csrf
        ...
        <div class="mb-3">
            ...
            <select name="id_tipo_atraccion" id="id_tipo_atraccion" class="form-select">
                ...
                @foreach($tipos as $tipo)
                    <option value="{{ $tipo->id_tipo_atraccion }}">{{ $tipo->nombre_tipo_atraccion }}</option>
                @endforeach
            </select>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="anio_creacion" id="anio_creacion" class="form-control">
        </div>

        <div class="mb-3">
            <label for="accesibilidad" class="form-label">Accesibilidad</label>
            <input type="text" name="accesibilidad" id="accesibilidad" class="form-control">
        </div>
